...
<body>
    ...
    <div class="container-option">
            ...
            <form action="sellerMyAcc" method="post">
                @csrf
                <button type="submit" class="btn btn-account"><span-account>My Account</span></button>
            </form>
            </div>
            <div class="col mb-5">
            <form action="sellerPlantitaDirect" method="post">
                @csrf
                <button type="submit" class="btn btn-products"><span-products>My Products</span></button>
            </form>
            </div>
            </div>
            <div class="row">
            ...
            <form action="sellerOrdersDirect" method="post">
                @csrf
                <button type="submit" class="btn btn-order"><span-order>Order Listing</span></button>
            </form>
            </div>
            <div class="col mb-5">
            <a href="/logout"><button class="btn btn-logout"><span-logout>Logout</span></button></a>
            </div>
            </div>
</div>
</div>
